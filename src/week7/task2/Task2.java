...
class Task2 {
    ...
    public
    String cutName(String s) throws NullPointerException {
        return s.substring(4, 6);
    }

    public
    int lastElement(int[] arr) throws ArrayIndexOutOfBoundsException {
    ...
    public
    int parseInt(Object s) throws ClassCastException {
        return (Integer) s;
    }
    ...
    public
    void writeFile(String filename, String s) throws IOException {
